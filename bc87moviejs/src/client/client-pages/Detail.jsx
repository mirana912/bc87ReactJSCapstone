// src/client/client-pages/Detail.jsx
...
export default function Detail() {
  ...
  useEffect(() => {
    (async () => {
      const info = await client.get("/QuanLyPhim/LayThongTinPhim", {
        params: { maPhim },
      });
      setPhim(info.data.content);
      const lichRes = await client.get("/QuanLyRap/LayThongTinLichChieuPhim", {
                    ...
                    <Stack direction="row" gap={1} flexWrap="wrap" mt={1}>
                      {cum.lichChieuPhim?.map((lc) => (
                        <Button
                          ...
                          onMouseEnter={() =>
                            client.get("/QuanLyDatVe/LayDanhSachPhongVe", {
