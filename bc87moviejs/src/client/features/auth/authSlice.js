// src/client/features/auth/authSlice.js
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.content || "Không tải được thông tin tài khoản",
      );
    }
  },
);
...
export const changePassword = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        err.response?.data?.content || "Đổi mật khẩu thất bại",
      );
    }
  },
);
...
const slice = createSlice({
  ...
  extraReducers: (b) => {
    b.addCase(fetchAccount.pending, (s) => {
      s.accountStatus = "loading";
      s.error = null;
    })
      ...
      .addCase(fetchAccount.rejected, (s, a) => {
        s.accountStatus = "failed";
